...
$("#add-movie").on("click", function (event) {
    ...
    renderButtons();
    // $(document).on("click"); // what am I doing wrong with this Jquery. I can not get the buttons to work after starting a new button. Question 2 how do i get the pictures to show inline instead of down the page. question 3 how do I animate the pictures. question 4 how do I clear the previous movie gifs
});
renderButtons();
